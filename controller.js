export default class Controller {
  ...
  // Add an Item to the model and display it in the list.
  ...
  removeCompletedItems() {
    this.model.remove({ completed: true }, this._filter.bind(this));
  }
  ...
  toggleAll(completed) {
    this.model.find({ completed: !completed }, data => {
      for (let { id } of data) {
        this.toggleCompleted(id, completed);
      }
    });
  ...
  _filter(force) {
    ...
    this.model.count((total, active, completed) => {
